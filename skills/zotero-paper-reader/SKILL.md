...
| Project type | PDF destination | Markdown destination | Filename format |
|---|---|---|---|
| Research project (`PROGRESS.md` exists) | `Literature/` | `Literature/Extracted/Author_Year/Author_Year.md` | `Author_Year` |
| Reading project (`READING-LOG.md` exists) | `Literature/` | `Extracted/Author_Year/Author_Year.md` | `Author_Year` |
...
```bash
python3 ~/vscodeproject/ResearchHub/skills/zotero-paper-reader/scripts/get_zotero_pdf.py ATTACHMENT_KEY
```
...
4. Downloads to `/tmp/[original_filename]`
...
### Step 4: Copy PDF to Literature/

Copy the PDF to the project's `Literature/` directory with a clean filename:

```bash
cp /tmp/original_name.pdf Literature/Author_Year.pdf
```

### Step 5: Convert to Markdown

Use the `mistral-pdf-to-markdown` skill to convert:
...
python3 ~/vscodeproject/ResearchHub/skills/mistral-pdf-to-markdown/scripts/convert_pdf_to_markdown.py \
  ...
  "<EXTRACTED_DIR>/Author_Year/Author_Year.md"
```

Where `<EXTRACTED_DIR>` is `Literature/Extracted` (research) or `Extracted` (reading).
...
Read(file_path="<EXTRACTED_DIR>/Author_Year/Author_Year.md", offset=1, limit=500)
```
...
3. Get PDF: `python3 ~/vscodeproject/ResearchHub/skills/zotero-paper-reader/scripts/get_zotero_pdf.py 2HSELEHX`
4. Copy: `cp /tmp/Du_et_al_2023.pdf Literature/Du_et_al_2023.pdf`
5. Convert: `python3 ~/vscodeproject/ResearchHub/skills/mistral-pdf-to-markdown/scripts/convert_pdf_to_markdown.py Literature/Du_et_al_2023.pdf Literature/Extracted/Du_et_al_2023/Du_et_al_2023.md`
6. Read: `Read(file_path="Literature/Extracted/Du_et_al_2023/Du_et_al_2023.md", limit=500)`
7. Summarize and offer to dive deeper into specific sections
